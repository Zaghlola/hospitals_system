										...
										<div class="card-sigin">
											<div class="main-signup-header">
												...
												<div class="form-group">
													...
													<select class="form-control" id="guardFormControlSelect">
												...
												<h5 class="font-weight-semibold mb-4">Please sign in as patient.</h5>
												...
												<div class="loginform" id="admin">
													<h5 class="font-weight-semibold mb-4">Please sign in as doctor.</h5>
...
@section('js')
<script>
	$('#guardFormControlSelect').change(function(){
var myId=$(this).val();
